...
var Search = function Search(_ref4) {
  var className = _ref4.className,
      ...
      _ref4$defaultFocussed = _ref4.defaultFocussed,
      defaultFocussed = _ref4$defaultFocussed === void 0 ? false : _ref4$defaultFocussed,
      defaultValue = _ref4.defaultValue,
      props = _objectWithoutProperties(_ref4, ["className", "onChange", "defaultFocussed", "defaultValue"]);

  var _useState = (0, _react.useState)(defaultFocussed),
      _useState2 = _slicedToArray(_useState, 2),
      focussed = _useState2[0],
      onSetFocussed = _useState2[1];

  return /*#__PURE__*/_react["default"].createElement(FilterForm, {
    autoComplete: "off",
    focussed: focussed,
    className: className,
  ...
  }, /*#__PURE__*/_react["default"].createElement(FilterField, _extends({
    type: "text",
