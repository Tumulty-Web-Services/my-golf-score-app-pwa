...
var FramesRenderer = function FramesRenderer(_ref) {
  ...
  var stringifiedQueryParams = (0, _stringifyQueryParams.stringifyQueryParams)(Object.assign(Object.assign({}, queryParams), version && {
    version: version
  }));
  ...
  (0, _react.useEffect)(function () {
    var newFrames = Object.values(refs).filter(function (r) {
      ...
      return Object.assign(Object.assign({}, acc), {}, _defineProperty({}, "storybook-ref-".concat(r.id), "".concat(r.url, "/iframe.html?id=").concat(storyId, "&viewMode=").concat(viewMode, "&refId=").concat(r.id).concat(stringifiedQueryParams)));
    }, frames);
    setFrames(newFrames);
  }, [storyId, story, refs]);
