...
var _babelLoaderManager = _interopRequireDefault(require("./babel-loader-manager"));

var _resolvePathInSbCache = require("../utils/resolve-path-in-sb-cache");

var _es6Transpiler = _interopRequireDefault(require("../common/es6Transpiler"));
...
var coreDirName = _path.default.dirname(require.resolve('@storybook/core/package.json')); // TODO: improve node_modules detection


var context = coreDirName.includes('node_modules') ? _path.default.join(coreDirName, '../../') // Real life case, already in node_modules
: _path.default.join(coreDirName, '../../node_modules'); // SB Monorepo
...
var _default = async function _default({
  ...
  return {
    ...
    }) : null, dll ? new _webpack.DllReferencePlugin({
      context: context,
      manifest: _path.default.join(coreDirName, 'dll', 'storybook_ui-manifest.json')
    ...
    module: {
      rules: [(0, _babelLoaderManager.default)(), (0, _es6Transpiler.default)(), {
        test: /\.css$/,
