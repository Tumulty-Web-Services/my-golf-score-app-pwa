...
var getAutoRefs = async function (options) {
  ...
  var list = await Promise.all(Object.keys(_objectSpread(_objectSpread({}, dependencies), devDependencies)).map(async function (d) {
    try {
      ...
      if (storybook === null || storybook === void 0 ? void 0 : storybook.url) {
...
async function getManagerWebpackConfig(options, presets) {
  ...
  if (definedRefs) {
    Object.entries(definedRefs).forEach(function ([key, value]) {
      if (value === null || value === void 0 ? void 0 : value.disabled) {
