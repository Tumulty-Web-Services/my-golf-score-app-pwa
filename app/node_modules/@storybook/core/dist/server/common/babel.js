...
exports.default = exports.presets = exports.plugins = void 0;
 ...
 */
require.resolve('@babel/plugin-proposal-optional-chaining'), require.resolve('@babel/plugin-proposal-nullish-coalescing-operator')];
...
var _default = function _default() {
  return {
    ...
    presets: [...presets],
    plugins: [...plugins, [require.resolve('babel-plugin-emotion'), {
      sourceMap: true,
      autoLabel: true
    }]]
  };
