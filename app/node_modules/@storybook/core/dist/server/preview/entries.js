...
var getMainConfigs = function (options) {
  var previewPath = (0, _loadPreviewOrConfigFile.loadPreviewOrConfigFile)(options);
...
async function createPreviewEntry(options) {
  ...
  var entries = [require.resolve('../common/polyfills'), require.resolve('./globals'), _path.default.resolve(_path.default.join(configDir, 'storybook-init-framework-entry.js'))];
