...
var render = function render(node, el) {
  return new Promise(function (resolve) {
    _reactDom["default"].render(process.env.STORYBOOK_EXAMPLE_APP ? /*#__PURE__*/_react["default"].createElement(_react.StrictMode, null, node) : node, el, resolve);
  });
};
...
function _renderMain() {
  _renderMain = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var storyFn, showMain, showException, forceRender, StoryFn, element;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            StoryFn = storyFn;
            element = /*#__PURE__*/_react["default"].createElement(ErrorBoundary, {
              showMain: showMain,
              showException: showException
            }, /*#__PURE__*/_react["default"].createElement(StoryFn, null)); // We need to unmount the existing set of components in the DOM node.
