...
function generateTypeFromString(value, originalTypeName) {
  ...
  switch (type) {
    ...
    case _inspection.InspectionType.ELEMENT:
      {
        ...
        _short2 = identifier != null && !(0, _lib2.isHtmlTag)(identifier) ? identifier : _lib2.ELEMENT_CAPTION;
    ...
    default:
      _short2 = getCaptionForInspectionType(type);
      compact = splitIntoLines(value).length === 1 ? value : null;
      full = value;
      break;
  }
      ...
      case PropTypesType.ARRAYOF:
        {
          ...
          return (0, _lib.createSummaryValue)(_short8, _short8 !== full ? full : undefined);
        }
