...
describe('parse', function () {
  describe('expression', function () {
    it('support HTML element', function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.ELEMENT);
    ...
    it('support PropTypes.shape', function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.OBJECT);
    ...
    it('support array', function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.ARRAY);
      expect(inferedType.depth).toBe(1);
      expect(result.ast).toBeDefined();
    });
    ...
    it('support object identifier', function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.IDENTIFIER);
    ...
    it('support anonymous function', function () {
      var result = (0, _acornParser.parse)('() => {}');
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.FUNCTION);
      expect(inferedType.identifier).toBeUndefined();
    ...
    it('support class', function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.CLASS);
    ...
    [{
      ...
      it("support ".concat(x.name), function () {
        ...
        var inferedType = result.inferedType;
        expect(inferedType.type).toBe(_types.InspectionType.LITERAL);
        expect(result.ast).toBeDefined();
      });
    });
    it("returns Unknown when it's not supported", function () {
      ...
      var inferedType = result.inferedType;
      expect(inferedType.type).toBe(_types.InspectionType.UNKNOWN);
      expect(result.ast).toBeDefined();
    });
  });
});