...
var extractArgTypesFromElements = function extractArgTypesFromElements(tagName, customElements) {
  ...
  return metaData && Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, mapData(metaData.attributes, 'attributes')), mapData(metaData.properties, 'properties')), mapData(metaData.events, 'events')), mapData(metaData.slots, 'slots')), mapData(metaData.cssProperties, 'css'));
};
